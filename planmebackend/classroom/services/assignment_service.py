...
class AssignmentsService:
    ...
    def process_courses(self, courses, access_token, check_status, user):
        ...
        for course in courses:
            ...
            new_tasks.extend(self.process_assignments(assignments, course_id, access_token, check_status, user))
        return new_tasks

    def process_assignments(self, assignments, course_id, access_token, check_status, user):
        tasks = []
        for assignment in assignments:
            ...
            tasks.append(self.create_task_from_assignment(assignment, due_date, user))
        return tasks

    @staticmethod
    def create_task_from_assignment(assignment, due_date, user):
        return Task(
